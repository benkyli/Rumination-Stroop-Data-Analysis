...
df <- read.csv("C:/CodingStuff/Thesis_Rumination_Stroop/FinalData/stroop_standard_trials.csv")
df2 <- read.csv("C:/CodingStuff/Thesis_Rumination_Stroop/FinalData/stroop_emotion_trials.csv")
